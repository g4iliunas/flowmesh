...
} _socks5_auth_method_t;
typedef uint8_t socks5_auth_method_t;
...
typedef uint8_t socks5_command_t;

typedef enum {
    SOCKS5_ADDR_TYPE_IPV4 = 0x01,
    SOCKS5_ADDR_TYPE_DOMAIN = 0x03,
    SOCKS5_ADDR_TYPE_IPV6 = 0x04
} _socks5_address_type_t;
typedef uint8_t socks5_address_type_t;
